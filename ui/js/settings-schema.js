...
export const CATEGORIES = [
  ...
  { id: 'memoria', icon: '📓', label: 'Memória', blocks: [
    ...
    { title: 'Grafo de Conhecimento', custom: 'rebuild' },
...
export const CUSTOM_HTML = {
  ...
  rebuild: '<button class="btn accent" id="btn-rebuild-kg" style="max-width:320px">🧠 Reconstruir grafo de Conhecimento</button>'
    + '<p class="muted" style="margin-top:8px">Relê todas as memórias, extrai os tópicos e reconstrói o grafo de Conversa. Use se o grafo estiver vazio ou desatualizado. Não apaga nada.</p>'
    + '<div id="rebuild-note" class="muted" style="margin-top:8px"></div>',
